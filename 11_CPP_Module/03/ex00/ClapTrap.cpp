...
ClapTrap::ClapTrap(const ClapTrap& origin) {
  std::cout << kTraps[kClap] << kMessages[kCopyConstructor] << kSuffix << '\n';
  *this = origin;
}

ClapTrap& ClapTrap::operator=(const ClapTrap& origin) {
  std::cout << kTraps[kClap] << kMessages[kCopyAssignmentOperator] << kSuffix
            << '\n';
  if (this != &origin) {
...
ClapTrap::~ClapTrap() {
  std::cout << kTraps[kClap] << kMessages[kDestructor] << kSuffix << std::endl;
}
